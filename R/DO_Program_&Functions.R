...
#' }
#'
#' @note \code{Observation:::data_collection_program_interactive()} is
...
#' @keywords internal
#'
#' @note \code{compendium_reference_interactive()} is called
...
#'   \code{\link{compendium_reference_interactive}}, that has
